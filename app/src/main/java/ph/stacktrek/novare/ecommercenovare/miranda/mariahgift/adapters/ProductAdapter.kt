package ph.stacktrek.novare.ecommercenovare.miranda.mariahgift.adapters
...
import ph.stacktrek.novare.ecommercenovare.miranda.mariahgift.databinding.ProductItemBinding
    ...
    inner class ViewHolder(private val productItemBinding: ProductItemBinding):
        ...
        fun bindItems(product: Product){
            ...
            productItemBinding.viewProductButton.setOnClickListener {
                Toast.makeText(context, "${product.name} \n ${product.description}", Toast.LENGTH_SHORT).show()
